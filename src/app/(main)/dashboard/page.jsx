...
const DashboardPage = async () => {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      {/* Budget Progress */}
      <div className="col-span-1 lg:col-span-8 bg-white/[0.03] border border-white/[0.08] rounded-2xl p-5 sm:p-6">
      ...
      <div className="col-span-1 lg:col-span-8 bg-white/[0.03] border border-white/[0.08] rounded-2xl p-5 sm:p-6">
        <div className="flex items-center justify-between mb-5">
          <div className="text-xs font-semibold tracking-widest uppercase text-slate-600">Overview</div>
      ...
      {/* Add Transaction */}
      <div className="col-span-1 lg:col-span-4 flex items-start justify-start lg:justify-end">
        <TransactionDrawer
          accounts={accounts}
          defaultAccountId={defaultAccount?.id}
          trigger={
            <Button
              className="flex items-center gap-2 text-white border-0 w-full lg:w-auto justify-center"
              style={{
