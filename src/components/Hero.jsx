        ...
        <div>
          ...
          <div className="flex items-center gap-3 mb-12">
            ...
            <span className="text-sm text-slate-500 ml-3">
              <strong className="text-slate-200 font-semibold">12,000+</strong> people trust FinCoach
            </span>
          </div>
          ...
          <div className="flex gap-0 border-t border-white/5 pt-8">
            {[
              ...
              { val: "98%", label: "Goal success rate" },
            ].map((s, i) => (
              <div
                key={s.label}
                className={`flex-1 ${i > 0 ? "pl-7 border-l border-white/5" : ""} ${i < 2 ? "pr-7" : ""}`}
              >
                <div className="text-[26px] font-extrabold tracking-tight text-white">{s.val}</div>
          ...
          <div className="bg-white/[0.03] border border-white/[0.08] rounded-2xl p-5 backdrop-blur-sm">
            ...
            <div className="flex justify-between items-center mb-5">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <div className="text-[13px] font-semibold text-slate-200">Hemal's finances</div>
                  <div className="text-[11px] text-slate-600">Personal account</div>
                </div>
              </div>
            ...
            <div className="inline-flex items-center gap-1.5 bg-teal-900/30 border border-teal-700/30 text-teal-400 text-[11px] font-semibold px-3 py-1 rounded-full mt-2 mb-5">
              <svg width="9" height="9" viewBox="0 0 9 9" fill="none"><path d="M1 6.5L4.5 2.5l3.5 4" stroke="#5dcaa5" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg>
              +8.4% this month
            </div>
            ...
            <div className="flex gap-1 mb-5">
              {bars.map((b) => (
                <div key={b.month} className={`flex-1 text-center text-[10px] ${b.active ? "text-blue-400 font-bold" : "text-slate-700"}`}>
                  {b.month}
                </div>
              ))}
            </div>
